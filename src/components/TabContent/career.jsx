      ...
      <div className="row mt-4">
        <div className="col-md-9 ">
          <p ref={refFour} className={styles.fadeIn}>
            ...
            extra year to study English. While studying I worked in the student
            bar, at a grocery shop and played and administrated the school
            handball team. I also helped plan and execute Fadderuka two times,
            which is a festival to welcome new students to the university.
          </p>
          <p ref={refFive} className={`${styles.fadeIn} mt-4`}>
            ...
            religion and cooking for two years. After having left Oslo for seven
            years it was time to move back home. I started working at
            Nesoddtangen skole, a primary school. Here I taught English, math,
            science and social studies. I was a team leader, and also had
            students in practice every year. Since the school wanted to
            implement coding I was chosen to be the schools coding expert. I
            started learning coding in 2019. I mainly started with block-coding
            to having something to start with with my pupils. And we built
            robots, and programmed them to do different tasks. We also started
            with minecraft coding. This got me thinking, and I looked in to
      ...
      <div className="row mb-3 mt-3">
        ...
        <div className="col-md-9 mt-1">
          <p ref={refSeven} className={styles.fadeIn}>
            ...
            also being the clubs representative in the handball federation. I
            also help plan and execute the clubs events and tournaments.
          </p>

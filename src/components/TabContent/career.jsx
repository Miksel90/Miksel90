    ...
    <div className="container text-white shadowText text-start fs-4 bg-dark bg-opacity-25 p-3">
      ...
      <div className="row mt-4">
        <div className="col-md-9">
          <FadeInText>
            I started my teacher`s degree at the University of Stavanger in 2011
            and graduated in 2016. I studied mathematics, social studies,
            religion, and cooking. After completing my degree, I took an extra
            year to study English. While studying, I worked at the student bar,
            a supermarket and played and administered the university handball
            team. I also helped plan and host Fadderuka two times, which is a
            festival to welcome students to the university.
          </FadeInText>
          <FadeInText className="mt-4">
            ...
            school wanted to implement coding, I was chosen to be the school`s
          ...
          <FadeInText className="mt-4">
            ...
            frontend development at Noroff. As of 2024, I have finished my two
            year degree with straight A`s and am currently looking for a new
            job!
          </FadeInText>
        </div>
        <div className="col-md-3">
          <FadeInImage src={imageOne} alt="Mikael Selstad" />
          <FadeInImage src={imageTwo} alt="Mikael Selstad" />
        </div>
      </div>
      <div className="row mb-3 mt-3">
        <div className="col-md-3">
          <FadeInImage src={imageThree} alt="Mikael Selstad" />
        </div>
        <div className="col-md-9 mt-1">
          <FadeInText>
            ...
            being the club`s representative in the handball federation. I also
            help plan and execute club events and tournaments.
          </FadeInText>
          <FadeInText>
            I`ve been studying frontend development for two years now, and I am
